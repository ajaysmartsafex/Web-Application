    ...
    <Container>
      <div className="table_container_section border-2 border-red-500 my-3">
        ...
        <div className="text-center">
          ...
          <div className="date">4=&gt;278-340-250-124</div>
          <div className="date">5=&gt;380-146-690-456</div>
          <div className="date">6=&gt;389-479-168-267</div>
          <div className="date">7=&gt;790-358-123-367</div>
          <div className="date">8=&gt;336-246-138-156</div>
          <div className="date">9=&gt;234-450-577-289</div>
          <div className="date">0=&gt;235-460-244-690</div>
        </div>
      </div>
      ...
      <div className="table_container_section border-2 border-red-500 my-3">
        ...
        <div className="text-center">
          ...
          <div className="date">Thu. 1-6-4-9</div>
          <div className="date">Fri. 7-8-9-0</div>
          <div className="date">Sat. 4-5-3-2</div>
          <div className="date">Sun. 1-6-4-9</div>
        </div>
      </div>
      ...
      <div className="table_container_section border-2 border-red-500 my-3">
        ...
        <div className="text-center">
          ...
          <div className="date">74-73-85-83</div>
          <div className="date">92-96-05-03</div>
          <div className="date">45-98-76-24</div>
        </div>
      </div>
    </Container>
  );
